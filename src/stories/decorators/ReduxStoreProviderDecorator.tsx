...
const initialGlobalState: AppRootStateType = {
    todolists: [
        {id: "todolistId1", title: "What to learn", filter: "all", entityStatus: RequestStatusType.idle, addedDate: '', order: 0},
        {id: "todolistId2", title: "What to buy", filter: "all", entityStatus:  RequestStatusType.loading, addedDate: '', order: 0}
    ] ,
    tasks: {
        ["todolistId1"]: [
